...
### Software Developer | ZMP Việt Nam
Oct 2025 - Present

- Developed backend services using TypeScript and Golang
- Designed and implemented backend logic to handle communication between robots and server systems
- Built scalable solutions integrating AWS services such as AWS IoT Core for secure device connectivity and data management
- Deployed and maintained backend infrastructure on AWS, leveraging serverless components and cloud monitoring
...
- DevOps: Managed Jenkins CI/CD, Kubernetes orchestration, Rancher across environments
...
- Microservices Architect - Designed and implemented scalable backend systems
...
- DevOps Practitioner - Personal Kubernetes homelab infrastructure
...
- **Portfolio:** [tantai.dev](https://tantai.dev)
- **Email:** [tai21042004@gmail.com](mailto:tai21042004@gmail.com)
